...
py.arg('--feature_loss_weight', type=float, default=0.2)
...
F_A = module.ResnetEncoder(input_shape=(args.crop_size, args.crop_size, 3))
F_B = module.ResnetEncoder(input_shape=(args.crop_size, args.crop_size, 3))
...
def train_G(A, B):
    with tf.GradientTape() as t:
        ...
        G_A_Feature = F_A(A2B, training=True)
        B_Feature = F_B(B, training=True)
        ...
        G_A_B_Feature_loss = identity_loss_fn(G_A_Feature, B_Feature)
